...
export default function RegistroPage() {
  ...
  const benefits = [
    "Acceso a mas de 3,000 subvenciones",
    "Recomendaciones personalizadas con IA",
    "Alertas de nuevas convocatorias",
    "Guias paso a paso para aplicar"
  ]
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-foreground text-background p-12 flex-col justify-between">
        <div>
          <Link href="/" className="inline-flex items-center gap-2 text-background/70 hover:text-background transition-colors">
        ...
        <div className="space-y-8">
          <div>
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-background text-foreground mb-6">
            ...
            <p className="text-background/70 text-lg">
              Unete a mas de 1,200 empresas que ya usan Syntia para financiar sus proyectos.
            </p>
          </div>
        ...
        <p className="text-sm text-background/50">
          Syntia 2024. Todos los derechos reservados.
        </p>
      </div>
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-8 lg:py-16">
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="text-center lg:text-left space-y-2">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-foreground text-background mb-4 lg:hidden">
                <Sparkles className="h-6 w-6" />
              </div>
            ...
            <Card className="border-border/50 shadow-sm">
              <CardHeader className="space-y-1 pb-4">
                <CardTitle className="text-lg">Datos de registro</CardTitle>
                <CardDescription>Introduce tus datos para crear tu cuenta</CardDescription>
              </CardHeader>
              <CardContent>
